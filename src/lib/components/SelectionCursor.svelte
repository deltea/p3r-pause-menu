...
<div
  ...
  style="left: {left + currentOption.name.length * 6 - 70}px; top: {top}px"
  style:transform="rotate({currentOption.rotation / 0.9 + 15}deg) scaleX({currentOption.name.length * 0.15 + 0.4}) scaleY({currentOption.name.length * 0.1 + 0.3})"
>
